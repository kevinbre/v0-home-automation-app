import { TvControl } from "@/components/tv-control"
  ...
  return (
    <div className="min-h-screen relative overflow-hidden">
      ...
      <div className="fixed inset-0 -z-10">
        ...
        <div className="absolute top-0 right-0 w-[500px] h-[500px] bg-[oklch(0.6_0.25_250)] rounded-full blur-[120px] opacity-20 animate-pulse" />
      ...
      <div className="container mx-auto px-4 py-6 max-w-7xl">
        <div className="glass rounded-3xl p-6 mb-6">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h1 className="text-2xl font-bold">Control de Smart TV</h1>
              <p className="text-sm text-muted-foreground">Controla tu televisor inteligente</p>
            </div>
          </div>
        </div>
